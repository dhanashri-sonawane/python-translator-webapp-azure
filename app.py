...
def index():
    mycursor.execute("SELECT * FROM translatordb")
...
def index_post():
    ...
    key="27c4a65406bb4a75a7da2d22c46fab47"
    ...
    sql = "INSERT INTO translatordb (translates_text, original_text, target_language) VALUES (%s, %s, %s)"
